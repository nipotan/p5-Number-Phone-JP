...
ok(! Number::Phone->new('+810112345678')->is_mobile, 'checking for 001 12345678');
ok(! Number::Phone->new('+810912012345678')->is_mobile, 'checking for 009120 12345678');
ok(! Number::Phone->new('+816033001234')->is_mobile, 'checking for 060 33001234');
ok(! Number::Phone->new('+81120000123')->is_mobile, 'checking for 0120 000123');
ok(! Number::Phone->new('+81112001234')->is_mobile, 'checking for 011 2001234');
